...
declare global {
  ...
  type ISocketData<E extends string = string> = ISocketData_HttpConnect | ISocketData_ServerEvent<E> | ISocketData_SocketEvent<E> | ISocketData_ConnectHttps | ISocketData_Data | ISocketData_WriteHead | ISocketData_End;
