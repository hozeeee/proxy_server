...
# vncserver -list 可以查看已启动的 vnc 服务列表
# vncserver -rfbport 6000 可以修改启动端口
...
ExecStart=$VNCSERVER_COMMAND_PATH :1 -localhost no -geometyr \${VNC_GEOMETRY} -fg
